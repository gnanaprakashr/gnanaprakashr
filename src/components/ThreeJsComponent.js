...
import reactNative from '../assets/images/reactnativeLight.jpg'
...
import iosApple from '../assets/images/IosApple.jpg'
...
function ThreeJsComponent() {
  ...
  //     const multiMaterial = [
  //       new THREE.MeshBasicMaterial({map: textureLoader.load(react.src)}),
  //       new THREE.MeshBasicMaterial({map: textureLoader.load(reactNative.src)}),
  //       new THREE.MeshBasicMaterial({map: textureLoader.load(nodeJs.src)}),
  //       new THREE.MeshBasicMaterial({map: textureLoader.load(nextJs.src)}),
  //       new THREE.MeshBasicMaterial({map: textureLoader.load(android.src)}),
  //       new THREE.MeshBasicMaterial({map: textureLoader.load(iosApple.src)}),
  //     ]
...
vertices.push(new THREE.Vector3(0, 2000, 0));
wireGeom.setAttribute('position', new THREE.Float32BufferAttribute(vertices.flat(), 3));
// wireGeom.vertices = []
// wireGeom.vertices.push(
// new THREE.Vector3( 0, 0, 0 ),
// new THREE.Vector3( 0, 2000, 0 )
